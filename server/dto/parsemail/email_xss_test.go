...
func TestSanitizeHTML(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			expected: ``, // bluemonday UGCPolicy 会移除带有危险属性的 img 标签
		},
		{
		...
		},
		{
			...
			expected: `Click me`, // bluemonday 在 href 危险时移除整个链接
		},
		{
