 ...
 * 国际化模块
 *
 * 从旧前端 fe/src/i18n/i18n.ts 迁移。支持中英双语，自动检测浏览器语言。
 *
 * 创建日期: 20260609
 */
...
const en: Record<string, string> = {
  ...
  setDNS: "Set DNS",
  setSSL: "Set SSL",
  dns_root_desc: "Fill in the \"@\" or empty.",
  ...
  guid_desc: "Next, you will be guided to perform initial configuration.",
  select_db: "select database",
  db_desc: "PMail currently supports MySQL and SQLite3 databases.",
  type: "Type",
  db_select_ph: "please select your database",
  mysql_dsn: "MySQL DSN",
  pg_dsn: "PostgreSQL DSN",
  sqlite_db_path: "Data File Path",
  domain_desc: "Set your domain information.",
  ...
  dns_challenge_wait: "DNS propagation may take 10-30 minutes.",
  ssl_challenge_type: "Challenge Type",
  ssl_auto_http: "Http Request",
  ssl_auto_dns: "DNS Records",
  challenge_typ_desc: "HTTP challenge is recommended if PMail uses port 80.",
  ...
  rule_desc: "When a new message meets all these conditions:",
  ...
  autoSSLWarn: "PMail is not running on port 80.",
  err_db_dsn_empty: "Database path cannot be empty!",
  modify_pwd_desc: "Update your account password.",
  ...
  email_folders_desc: "Manage your custom mail folders.",
  ...
  login_brand_desc: "Secure, elegant and distraction-free email experience.",
  ...
  csv_preview: "Preview",
  csv_no_email_found: "No valid email addresses found",
  ...
  reply_email: "Reply",
  select_email_hint: "Select an email to read",
...
const zhCN: Record<string, string> = {
  ...
  next: "下一步",
  tks_pmail: "感谢使用PMail",
  guid_desc: "接下来将会指引你进行初始化配置。",
  select_db: "数据库选择",
  db_desc: "PMail目前支持MySQL和SQLite3两种数据库。",
  type: "类型",
...
const lang = browserLang.toLowerCase().startsWith("zh") ? zhCN : en
